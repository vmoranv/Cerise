...
from ctypes import c_bool, c_double, c_uint32

from ....idldsl import (
    GUID,
    _non_activatable_init,
    _static_method,
    _static_propget,
...
from ...Foundation import IAsyncOperation, IReference, Rect
from ...Foundation.Collections import IVectorView
from ...Globalization import Language
from ...Graphics.Imaging import SoftwareBitmap
