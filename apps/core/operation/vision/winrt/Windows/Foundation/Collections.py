...
from ctypes import c_bool, c_uint, c_uint32
from functools import lru_cache

from ....idldsl import define_winrt_com_method, pinterface_type
...
@lru_cache
def IIterator(T):  # noqa: ANN001,N802
    cls = pinterface_type(
        "IIterator",
        "6a79e863-4300-459a-9966-cbb660963ee1",
        (T,),
        (IInspectable, IIterator_helpers),
    )
...
@lru_cache
def IIterable(T):  # noqa: ANN001,N802
    cls = pinterface_type(
        "IIterable",
        "faa585ea-6214-4217-afda-7f46de5869b3",
        (T,),
        (IInspectable, IIterable_helpers),
    )
...
@lru_cache
def IVectorView(T):  # noqa: ANN001,N802
    cls = pinterface_type(
        "IVectorView",
