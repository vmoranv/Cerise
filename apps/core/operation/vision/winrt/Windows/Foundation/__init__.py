...
import asyncio
from ctypes import HRESULT, Structure, WinError, c_float, c_int, c_int32, c_uint32, windll

from ... import delegate
from ...idldsl import GUID, define_winrt_com_delegate, define_winrt_com_method, generics_cache, pinterface_type
...
@generics_cache
def AsyncOperationCompletedHandler(T):  # noqa: ANN001,N802
    cls = pinterface_type(
...
class IAsyncOperation_helpers:
    def as_future(self):
        ...
        def callback(iao, status):  # noqa: ANN001
            status = status.value
...
@generics_cache
def IAsyncOperation(T):  # noqa: ANN001,N802
    cls = pinterface_type(
        "IAsyncOperation",
...
@generics_cache
def IReference(T):  # noqa: ANN001,N802
...
@generics_cache
def TypedEventHandler(TSender, TResult):  # noqa: ANN001,N802
    cls = pinterface_type(
        "IAsyncOperationCompletedHandler",
